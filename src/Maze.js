...
class Maze extends React.Component {
    ...
    render() {
      ...
      return (
        ...
        <h1>Rat in a Maze</h1> 
        <div id="text">
        The well-known "rat in a maze" puzzle comes to life in this web application. It shows every route a rat may possibly walk through a square maze with fixed obstacles. A given N x N-dimensional maze exists. The top-left cell is the source, and the bottom-right cell is the destination. While certain cells can be moved, others are prohibited. Only one right or downward step can be made by the rat at once. If the rat begins to move from the start vertex to the target vertex, we must determine if it is capable of reaching the goal; if so, the rat's proper pathways are indicated.
          </div>
        </center>
        <br></br>      
         <Grid container spacing = {2} justify="center" direction="column">
           <p>
            ...
            <div><center>
              <Button onClick={this.handleClick} style={{margin: 15,  color: "white", background: "#ff82c5", padding: 8}}>
              <b>Generate new maze</b></Button>
              <Button onClick={this.findPaths} style={{margin: 15,  color: "white", background: "#ff82c5", padding: 8}}>
